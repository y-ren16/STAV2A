...
class AudioDataset(Dataset):
    def __init__(self, src, repro = False):
        ...
        if os.path.isfile(self.src):
            self.filelist = self.get_files_from_json()
        else:
    ...
    def readaudio(self, file):
        ...
        if "apdcephfs_cq8" in file:
            file=file.replace("apdcephfs_cq8", "apdcephfs_cq8_300883981")

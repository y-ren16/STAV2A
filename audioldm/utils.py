...
CACHE_DIR = os.getenv("AUDIOLDM_CACHE_DIR","./saved/pretrained_model")
...
def get_metadata():
    return {
        ...
        "audioldm2-full": {
            "path": "/xxxxxx/experiments/pretrain_models/audioldm2/audioldm2-full/audioldm2-full.pth",
        },
        "audioldm-m-full": {
            "path": "/xxxxxx/experiments/pretrain_models/audioldm2/audioldm2-full-large-1150k/audioldm2-full-large-1150k.pth"
        },
        "audioldm-m-full": {
            "path": "/xxxxxx/experiments/pretrain_models/audioldm2/audioldm2-full-large-650k/audioldm2-full-large-650k.pth"
        },
